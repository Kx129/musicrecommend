...
class Song(models.Model):
    ...
    song_img = models.ImageField(verbose_name='歌曲图片', max_length=50,upload_to='static/songImg')
    song_lyrics = models.FileField(verbose_name='歌词', max_length=50, default='暂无歌词',upload_to='static/songLyric')
    song_file = models.FileField(verbose_name='歌曲文件', max_length=50,upload_to='static/songFile')
...
class UserSongRecord(models.Model):
...
class ListenRecord(models.Model):
    ...
    user = models.ForeignKey(MyUser, on_delete=models.CASCADE, verbose_name='听歌用户')
    song = models.ForeignKey(Song, on_delete=models.CASCADE, verbose_name='听歌歌曲')
